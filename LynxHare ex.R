...
setwd("~/Downloads/ENEC 490(JANET)/lotka_voltera_Competition Model/LynxHare.csv") #For laptop

#Import the csv file that has the lynx and hare data

one<-read.csv("~/Downloads/ENEC 490(JANET)/lotka_voltera_Competition Model/LynxHare.csv")
...
# r= in the hw explain what these are!
#beta=
#delta=
#q=
pars <- c(r = 1, beta = 0.2, delta = 0.5, q = 0.01)
...
plot(lv_results[,1],lv_results[,2],type="l",col="maroon",ylim=c(0,5))
